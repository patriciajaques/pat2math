...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/pat2math/patequation/css/bootstrap.css" type="text/css"/>
        <!--<link rel="stylesheet" href="//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css">-->
        <link rel="stylesheet" href="/pat2math/patequation/css/index.css" type="text/css"/>
        <link rel="stylesheet" href="/pat2math/patequation/css/paper.css" type="text/css"/>
        <link rel="stylesheet" href="/pat2math/patequation/css/calculator.css" type="text/css"/>
        <link href="/pat2math/patequation/divalite/divakit/divajquery/jquery-ui.css" rel="stylesheet" type="text/css"/>
        <link href="/pat2math/patequation/divalite/divakit/divacharkit/divalite.css" rel="stylesheet" type="text/css"/> 

        <script type="text/javascript" src="/pat2math/patequation/divalite/divakit/divajquery/jquery-1.5.2.js"></script>
        <script type="text/javascript" src="/pat2math/patequation/divalite/divakit/divajquery/jquery-ui.min.js"></script>
        <script type="text/javascript" src="/pat2math/patequation/divalite/divakit/divalite.js"></script>
        <script src="/pat2math/patequation/js/divaliteAux.js" type="text/javascript" charset="utf-8"></script>
        ...
        <script src="/pat2math/patequation/js/bootstrap.js" type="text/javascript" charset="utf-8"></script>
        <!--<script src="//netdna.bootstrapcdn.com/bootstrap/3.0.0/js/bootstrap.min.js"></script>-->
        <script src="/pat2math/patequation/js/paint.js" type="text/javascript" charset="utf-8"></script>
        <script src="/pat2math/patequation/js/calculator.js" type="text/javascript" charset="utf-8"></script>
        <script src="/pat2math/patequation/js/paper.js" type="text/javascript" charset="utf-8"></script>
        <script src="/pat2math/patequation/js/index.js" type="text/javascript" charset="utf-8"></script>
    ...
    <center>
        <div id="book">
            ...
            <!--            <div class="backCover">
                            <span class="toolsFont">Ferramentas</span>
                                            <div class="note vLine canCopyTools">
                                                <ul id="toolsUl">
                                                    <li><math><mo>+</mo></math></li>
                                                    <li><math><mo>-</mo></math></li>
                                                    <li><math><mo>Ã</mo></math></li>
                                                    <li><math><mo>Ã·</mo></math></li>
                                                    <li><math><mo>=</mo></math></li>
                                                    <li><math><mo>(</mo></math></li>
                                                    <li><math><mo>)</mo></math></li>
                                                    <li><math><msup><mn>a</mn><mn>2</mn></msup></math></li>
                                                    <li><math><msqrt><mn>a</mn></msqrt></math></li>
                                                    linethickness="thick"
                                                    <li><math><mfrac><mn>a</mn><mn>b</mn></mfrac></math></li>                        
                                                </ul>
                                                <br>
                            ...
                            <div id="bars" class="well well-small">
                                <div class="row-fluid">
                                    <div class="span4">
                                        <span>PontuaÃ§Ã£o:</span>
                                        <center>
                                            <span id="pointBar" class="label label-info">10 de 20 pontos</span>
                                        </center>
                                    </div>
                                    <div class="span4">
                                        <span>Desempenho:</span>
                                        <div id="performanceBar" class="progress progress-striped">
                                            <div class="bar" style="width: 0%"></div>
                                        </div>
                                    </div>
                                    <div class="span4">
                                        <span>Barra de progresso:</span>
                                        <div id="progressBar" class="progress progress-info progress-striped">
                                            <div class="bar" style="width: 0%"></div>
                                        </div>
                                    </div>
                                </div>                    
            ...
            <div id="papers">                
                <div id="note">
                    ...
                    <!--                    <button id="newEquation">New Equation</button>                    -->
                    <button id="hint" onclick="hint();" class="btn btn-info">D i c a</button>
                </div>
                <div class="tape"></div> 
                        ...
                        <div class="hLine">
                            <table class="systemHelp">
                                <tr>
                                    ...
                                    <td>
                                        OperaÃ§Ã£o de taÃ­z quadrada (um elemento): tecla <span class="kbd">r</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
                        <div class="hLine">
                             <table class="systemHelp">
                                <tr>
                                    ...
                                    <td>
                                        OperaÃ§Ã£o de taÃ­z quadrada (vÃ¡rios elementos): tecla <span class="kbd">r</span>
                                    </td>
                                </tr>
                            </table>
                        </div>
    ...
    <!-- <div style="position: fixed; top: 0; left: 0">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                ...
                <li class="divider"></li>
                <li><a id="abc" tabindex="-1" onclick="referenceToABC();" accesskey="t">Encontrar a, b e c</a></li>
