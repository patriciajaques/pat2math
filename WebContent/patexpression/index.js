...
function createPlans() {
	var plans = '<span class="topic" onclick="loadTasks(10000)">Adição e Subtração</span> <div id="tasks10000" class="tasks"></div>' +
				'<span class="topic" onclick="loadTasks(10001)">Todas as operações</span> <div id="tasks10001" class="tasks"></div>' +
				'<span class="topic" onclick="loadTasks(10002)">Parênteses ( )</span> <div id="tasks10002" class="tasks"></div>' +
				'<span class="topic" onclick="loadTasks(10003)">Colchetes [ ]</span> <div id="tasks10003" class="tasks"></div>' +
				'<span class="topic" onclick="loadTasks(10004)">Chaves { }</span> <div id="tasks10004" class="tasks"></div>';
