...
function getSortedIds ( ) {
	...
	sortedIds[230] = new EquationId (230, 170, 12);
	sortedIds[231] = new EquationId (231, 171, 12);
	sortedIds[232] = new EquationId (232, 172, 12);
	sortedIds[233] = new EquationId (233, 173, 12);
	sortedIds[234] = new EquationId (234, 174, 12);
	sortedIds[235] = new EquationId (235, 175, 12);
	sortedIds[236] = new EquationId (236, 176, 13);
	sortedIds[237] = new EquationId (237, 177, 13);
	sortedIds[238] = new EquationId (238, 178, 13);
	sortedIds[239] = new EquationId (239, 179, 13);
	sortedIds[240] = new EquationId (240, 180, 13);
	sortedIds[241] = new EquationId (241, 197, 13);
	sortedIds[243] = new EquationId (243, 198, 13);
	sortedIds[244] = new EquationId (244, 199, 13);
	sortedIds[245] = new EquationId (245, 200, 13);
	sortedIds[246] = new EquationId (246, 201, 13);
	sortedIds[247] = new EquationId (247, 202, 13);
	sortedIds[248] = new EquationId (248, 203, 14);
	sortedIds[249] = new EquationId (249, 204, 14);
	sortedIds[250] = new EquationId (250, 205, 14);
	sortedIds[251] = new EquationId (251, 164, 14);
	sortedIds[252] = new EquationId (252, 165, 14);
	sortedIds[253] = new EquationId (253, 166, 14);
	sortedIds[254] = new EquationId (254, 167, 14);
	sortedIds[255] = new EquationId (255, 168, 14);
	sortedIds[256] = new EquationId (256, 169, 14);
	sortedIds[257] = new EquationId (257, 206, 14);
	sortedIds[258] = new EquationId (258, 207, 14);
	sortedIds[259] = new EquationId (259, 208, 14);
	sortedIds[260] = new EquationId (260, 209, 14);
	sortedIds[261] = new EquationId (261, 210, 14);
	sortedIds[262] = new EquationId (262, 211, 14);
	sortedIds[263] = new EquationId (263, 212, 14);
	sortedIds[264] = new EquationId (264, 213, 15);
	sortedIds[265] = new EquationId (265, 214, 15);
	sortedIds[266] = new EquationId (266, 215, 15);
	sortedIds[267] = new EquationId (267, 216, 15);
	sortedIds[268] = new EquationId (268, 217, 15);
	sortedIds[269] = new EquationId (269, 218, 15);
	sortedIds[270] = new EquationId (270, 181, 15);
	sortedIds[271] = new EquationId (271, 182, 15);
	sortedIds[272] = new EquationId (272, 183, 15);
	sortedIds[273] = new EquationId (273, 184, 15);
	sortedIds[274] = new EquationId (274, 185, 16);
	sortedIds[275] = new EquationId (275, 186, 16);
	sortedIds[276] = new EquationId (276, 187, 16);
	sortedIds[277] = new EquationId (277, 188, 16);
	sortedIds[278] = new EquationId (278, 189, 16);
	sortedIds[279] = new EquationId (279, 227, 16);
	sortedIds[280] = new EquationId (280, 228, 16);
	sortedIds[281] = new EquationId (281, 229, 16);
	sortedIds[282] = new EquationId (282, 230, 16);
	sortedIds[283] = new EquationId (283, 231, 16);
	sortedIds[284] = new EquationId (284, 232, 16);
	sortedIds[285] = new EquationId (285, 233, 16);
	sortedIds[286] = new EquationId (286, 234, 17);
	sortedIds[287] = new EquationId (287, 235, 17);
	sortedIds[288] = new EquationId (288, 236, 17);
	sortedIds[289] = new EquationId (289, 237, 17);
	sortedIds[290] = new EquationId (290, 238, 17);
	sortedIds[291] = new EquationId (291, 239, 17);
	sortedIds[292] = new EquationId (292, 240, 17);
	sortedIds[293] = new EquationId (293, 190, 17);
	sortedIds[294] = new EquationId (294, 191, 18);
	sortedIds[295] = new EquationId (295, 192, 18);
	sortedIds[296] = new EquationId (296, 193, 18);
	sortedIds[297] = new EquationId (297, 194, 18);
	sortedIds[298] = new EquationId (298, 195, 18);
	sortedIds[299] = new EquationId (299, 196, 18);
	sortedIds[300] = new EquationId (300, 241, 18);
	sortedIds[301] = new EquationId (301, 242, 18);
	sortedIds[302] = new EquationId (302, 243, 18);
	sortedIds[303] = new EquationId (303, 244, 18);
	sortedIds[304] = new EquationId (304, 245, 18);
	sortedIds[305] = new EquationId (305, 246, 18);
	sortedIds[306] = new EquationId (306, 247, 18);
	sortedIds[307] = new EquationId (307, 248, 18);
	sortedIds[308] = new EquationId (308, 249, 19);
	sortedIds[309] = new EquationId (309, 250, 19);
	sortedIds[310] = new EquationId (310, 251, 19);
	sortedIds[311] = new EquationId (311, 252, 19);
	sortedIds[312] = new EquationId (312, 253, 19);
	sortedIds[313] = new EquationId (313, 219, 19);
	sortedIds[314] = new EquationId (314, 220, 19);
	sortedIds[315] = new EquationId (315, 221, 19);
	sortedIds[316] = new EquationId (316, 222, 19);
	sortedIds[317] = new EquationId (317, 223, 19);
	sortedIds[318] = new EquationId (318, 224, 19);
	sortedIds[319] = new EquationId (319, 225, 19);
	sortedIds[320] = new EquationId (320, 226, 19);
	sortedIds[321] = new EquationId (321, 254, 20);
	sortedIds[322] = new EquationId (322, 255, 20);
	sortedIds[323] = new EquationId (323, 256, 20);
	sortedIds[324] = new EquationId (324, 257, 20);
	sortedIds[325] = new EquationId (325, 258, 20);
	sortedIds[326] = new EquationId (326, 259, 20);
	sortedIds[327] = new EquationId (327, 260, 20);
	sortedIds[328] = new EquationId (328, 261, 20);
	sortedIds[329] = new EquationId (329, 262, 20);
	sortedIds[330] = new EquationId (330, 263, 20);
	sortedIds[331] = new EquationId (331, 264, 20);
	sortedIds[332] = new EquationId (332, 265, 20);
	sortedIds[333] = new EquationId (333, 266, 21);
	sortedIds[334] = new EquationId (334, 267, 21);
	sortedIds[335] = new EquationId (335, 268, 21);
	sortedIds[336] = new EquationId (336, 269, 21);
	sortedIds[337] = new EquationId (337, 270, 21);
	sortedIds[338] = new EquationId (338, 271, 21);
	sortedIds[339] = new EquationId (339, 272, 21);
	sortedIds[340] = new EquationId (340, 273, 21);
	sortedIds[341] = new EquationId (341, 274, 21);
	sortedIds[342] = new EquationId (342, 275, 21);
	sortedIds[343] = new EquationId (343, 276, 21);
	sortedIds[344] = new EquationId (344, 277, 21);
	sortedIds[345] = new EquationId (345, 278, 21);
	sortedIds[346] = new EquationId (346, 279, 21);
}
