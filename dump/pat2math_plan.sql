...
CREATE TABLE `plan` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_puotg6niror0afl5dydvqg0qq` (`teacher_id`),
  CONSTRAINT `FK_puotg6niror0afl5dydvqg0qq` FOREIGN KEY (`teacher_id`) REFERENCES `user` (`id`)
...
INSERT INTO `plan` VALUES (1,'Plano Colégio São Luiz',1);
