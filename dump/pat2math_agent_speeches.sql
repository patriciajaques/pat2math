...
--
-- Table structure for table `agent_speeches`
--

DROP TABLE IF EXISTS `agent_speeches`;
...
--
-- Dumping data for table `agent_speeches`
--

LOCK TABLES `agent_speeches` WRITE;
/*!40000 ALTER TABLE `agent_speeches` DISABLE KEYS */;
/*!40000 ALTER TABLE `agent_speeches` ENABLE KEYS */;
UNLOCK TABLES;
