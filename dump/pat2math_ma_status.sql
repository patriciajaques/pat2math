...
--
-- Table structure for table `ma_status`
--
...
--
-- Dumping data for table `ma_status`
--

LOCK TABLES `ma_status` WRITE;
/*!40000 ALTER TABLE `ma_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `ma_status` ENABLE KEYS */;
UNLOCK TABLES;
