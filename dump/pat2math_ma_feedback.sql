...
--
-- Table structure for table `ma_feedback`
--
...
CREATE TABLE `ma_feedback` (
  ...
  `isExperimentalGroup` tinyint(1) NOT NULL,
...
--
-- Dumping data for table `ma_feedback`
--

LOCK TABLES `ma_feedback` WRITE;
/*!40000 ALTER TABLE `ma_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `ma_feedback` ENABLE KEYS */;
UNLOCK TABLES;
